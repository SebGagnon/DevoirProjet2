...
with open('Données-1000-Leila.csv', 'r') as file:
    entete=next(file)
...
ax.set(xlim=(1, 1000), xticks=[1,100,200,300,400,500,600,700,800,900,1000],
       ylim=(0.9995*np.min(tension), 1.0005*np.max(tension)), yticks=np.linspace(np.min(tension),np.max(tension),len(espacement)))
